...
You have more than 300 users in your app and 185 of them are using version `v1.7` which is as well the latest.
...
<DocImage src="/docs/version-adoption.png" width="502" height="392" smallImage/>
