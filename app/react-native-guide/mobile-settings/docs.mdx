...
export default ({ children }) => <DocLayout current="mobile-settings" previous={{href: '/react-native-guide/mobile-publishing', label: 'Mobile Publishing'}} next={{href: '/web-guide/introduction', label: 'Web Introduction'}}>{children}</DocLayout>