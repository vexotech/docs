...
You can programmatically enable or disable tracking in your app based on your business logic and requirements.
This gives you full control over when analytics data is sent.
