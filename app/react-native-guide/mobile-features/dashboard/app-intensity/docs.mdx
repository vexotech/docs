...
export default ({ children }) => <DocLayout current="app-intensity" previous={{href: '/react-native-guide/mobile-features/dashboard/version-adoption', label: 'Version Adoption'}} next={{href: '/react-native-guide/mobile-features/dashboard/errors', label: 'Errors'}}>{children}</DocLayout>