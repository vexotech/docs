...
<DocImage src="/docs/app-intensity.png" width="502" height="260" size="small" />

export default ({ children }) => <DocLayout current="app-intensity" previous={{href: '/react-native-guide/mobile-features/dashboard/version-adoption', label: 'Version Adoption'}} next={{href: '/react-native-guide/mobile-features/dashboard/customize-dashboard', label: 'Customize your Dashboard'}}>{children}</DocLayout>