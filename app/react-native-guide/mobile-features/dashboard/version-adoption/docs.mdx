...
<DocImage src="/docs/version-adoption.png" size="small" />

export default ({ children }) => <DocLayout current="version-adoption" previous={{href: '/react-native-guide/mobile-features/dashboard/users-devices', label: 'Users Devices'}} next={{href: '/react-native-guide/mobile-features/dashboard/app-intensity', label: 'App Usage'}}>{children}</DocLayout>