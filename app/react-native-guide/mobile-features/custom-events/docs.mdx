...
export default ({ children }) => <DocLayout
    ...
    previous={{href: '/react-native-guide/mobile-features/session-replays-heatmaps', label: 'Session Replays & Heatmaps'}}
    next={{href: '/react-native-guide/mobile-publishing', label: 'Mobile Publishing'}} >
        {children}
</DocLayout>
