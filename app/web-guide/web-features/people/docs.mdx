...
<DocImage src="/docs/web-people-list.png" width="1018" height="392" size="large" />
...
export default ({ children }) => <DocLayout current="web-people" previous={{href: '/web-guide/web-features/dashboard/funnels', label: 'Funnels'}} next={{href: '/web-guide/web-features/session-replays', label: 'Session Replays'}}>{children}</DocLayout>