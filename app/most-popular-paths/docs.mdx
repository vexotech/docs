...
Most popular paths offers a visual representation of the user journeys frequently taken within your app.
These paths are presented as sequences of screens, each accompanied by its name and screenshot.
They are organized in descending order of popularity, reflecting the number of users who have completed each path.

<DocImage src="/docs/most-popular-paths.png" width="1022" height="744"/>

A path is established withing a [session](https://vexo.co/docs/sessions), meaning it will be recorded from the moment the user opens the app until its closure.
